;(function (window) {
  ...
  let texts = ['蔚蓝星空下', '现在我独自野望', '星海闪烁', '仿佛在问', '你是不是困了', '是啊', '被浪费的一天', '是乏味的', '让我困倦', '但', '11月3日不同', '因你的生日', '纯净', '奇幻', '神秘', '这天十分有意义', '张雅卓！！！','❤生日快乐❤','愿远方的星星', '小小的星光', '不过分炙热', '不会灼伤你', '给你温暖', 'Always', '爱你的凡宝宝', 'End']
