;(function (window) {
  ...
  let texts = ['蔚蓝星空下', '现在我独自野望', '星海闪烁', '仿佛在问', '你是不是困了', '是啊', '被浪费的一天', '是乏味的', '让我困倦', '但~', '3月28日不同', '因你的生日', '纯净', '奇幻', '神秘', '这天十分有意义', '越宝宝！！！','❤生日快乐❤','愿远方的星星', '小小的星光', '不过分炙热', '不会灼伤你', '给你温暖', 'Always', '爱你的二傻子', 'End']
  ...
  class Particle {
    constructor (canvas) {
      ...
      // 透明度相关
      this.opacity = 0
      this.fadeInRate = 0.073
      this.fadeOutRate = 0.09
